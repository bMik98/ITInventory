 ...
 */
@Configuration
@ComponentScan("ru.regionsgroup.inventory.config")
...
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("ru.regionsgroup.inventory");
...
//        properties.put("hibernate.jdbc.fetch_size", environment.getRequiredProperty("hibernate.jdbc.fetch_size"));
        ...
        properties.put("hibernate.order_inserts", environment.getRequiredProperty("hibernate.jdbc.batch_size"));
        properties.put("hibernate.order_updates", environment.getRequiredProperty("hibernate.jdbc.batch_size"));
